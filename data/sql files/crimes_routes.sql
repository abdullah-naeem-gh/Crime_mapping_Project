...
CREATE TABLE `routes` (
  ...
  CONSTRAINT `routes_ibfk_1` FOREIGN KEY (`startLocation`) REFERENCES `locations` (`name`),
  CONSTRAINT `routes_ibfk_2` FOREIGN KEY (`endLocation`) REFERENCES `locations` (`name`)
