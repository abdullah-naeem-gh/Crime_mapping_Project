...
CREATE TABLE `occurrences` (
  `occurrenceID` varchar(50) NOT NULL,
  `crimeID` varchar(50) DEFAULT NULL,
  `location` varchar(50) DEFAULT NULL,
  `occurred_time` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`occurrenceID`),
  KEY `crimeID` (`crimeID`),
  KEY `location` (`location`),
  CONSTRAINT `occurrences_ibfk_1` FOREIGN KEY (`crimeID`) REFERENCES `crimes` (`crimeID`),
  CONSTRAINT `occurrences_ibfk_2` FOREIGN KEY (`location`) REFERENCES `locations` (`name`)
...
-- Dump completed on 2024-04-19 23:42:42
